...
This handbook is for people working on Astrid, not with it. If you are building a capsule, the
front-door documentation and The Astrid Book are your references. If you are changing the
kernel, the SDK, a contract surface, or a reference capsule, read this first.
